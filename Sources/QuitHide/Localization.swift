...
enum L10n {
    enum Key: String, CaseIterable {
        ...
        case statusInUse = "status.in_use"
        ...
        case statusStageManagerShowingDesktop = "status.stage_manager.showing_desktop"
        ...
        case settingsStageManagerProtectionShowingDesktop = "settings.stage_manager_protection.showing_desktop"
